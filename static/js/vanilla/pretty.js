// adding min/max capabilities
document.querySelector("._sidebar ._minimizebutton").addEventListener('click', () => {
    const sidebar = document.querySelector("._sidebar");
    const sidebarBody = document.querySelector("._sidebar ._body");

    if (sidebar.dataset.state == "max") { // if maximized
        sidebar.dataset.state = "min";
        ...
        sidebar.style.height = "45px";
        sidebar.style.minHeight = "45px";

    } else if (sidebar.dataset.state == "min") { // maximize
        sidebar.dataset.state = "max";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function Confetto() {
        ...
        this.position = {
            x: canvas.width / 2 + randomRange(-20, 20),
            y: canvas.height / 2 + randomRange(-20, 20)
        }
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        // Reset button
                        disabled = false;
                        button.classList.remove('loading', 'complete', 'fail');
                        button.classList.add('ready');
                    }, 4000);
